...
<div data-id="id-<?php echo $count; ?>" class="one_half <?php if($terms) : foreach ($terms as $term) { echo 'term-'.$term->term_id.' '; } endif; ?>">
...
<img src="<?php echo $gal_thumbnail_crop; ?>" alt="" width="445" height="273" />
</a>
...
<img src="<?php echo $gal_lightbox2_crop; ?>" alt="" width="445" height="273" style="display:none" />
</a>
<?php endif; ?>

<?php if(!empty($gal_lightbox3)): ?>			
<a data-gal="prettyPhoto[group<?php echo $photo_group; ?>]" href="<?php echo $gal_lightbox3; ?>">
<img src="<?php echo $gal_lightbox3_crop; ?>" alt="" width="445" height="273" style="display:none" />
</a>
<?php endif; ?>

<?php if(!empty($gal_lightbox4)): ?>			
<a data-gal="prettyPhoto[group<?php echo $photo_group; ?>]" href="<?php echo $gal_lightbox4; ?>">
<img src="<?php echo $gal_lightbox4_crop; ?>" alt="" width="445" height="273" style="display:none" />
</a>
<?php endif; ?>			

<?php if(!empty($gal_lightbox5)): ?>			
<a data-gal="prettyPhoto[group<?php echo $photo_group; ?>]" href="<?php echo $gal_lightbox5; ?>">
<img src="<?php echo $gal_lightbox5; ?>" alt="" width="445" height="273" style="display:none" />
</a>
<?php endif; ?>					
