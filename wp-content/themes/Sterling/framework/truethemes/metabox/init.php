...
define('CMB_META_BOX_URL', get_template_directory_uri() . '/framework/truethemes/metabox/');
...
function cmb_styles_inline() { 
	...
	<style type="text/css">
		...
		p.cmb_metabox_description { color: #999 !important; font-style: italic; margin: 2px 0 !important;font-size:11px !important;font-weight:normal !important;}
