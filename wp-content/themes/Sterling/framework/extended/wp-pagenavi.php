...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','framework_localize');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo;','framework_localize');
	$pagenavi_options['last_text'] = __('&raquo;','framework_localize');
	$pagenavi_options['next_text'] = __('&raquo;','framework_localize');
	$pagenavi_options['prev_text'] = __('&laquo;','framework_localize');
	$pagenavi_options['dotright_text'] = __('...','framework_localize');
	$pagenavi_options['dotleft_text'] = __('...','framework_localize');
