...
<section id="content-container" class="clearfix">
	...
	<p class="archive-heading"><?php _e('Archive for','framework_localize') ?> '<?php single_cat_title(); ?>'</p>
	<?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
	<p class="archive-heading"><?php _e('Posts Tagged','framework_localize') ?> '<?php single_tag_title(); ?>'</p>
	<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
	<p class="archive-heading"><?php _e('Archive for','framework_localize') ?> <?php the_time('F jS, Y'); ?></p>
	<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
	<p class="archive-heading"><?php _e('Archive for','framework_localize') ?> <?php the_time('F, Y'); ?></p>
	<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
	<p class="archive-heading"><?php _e('Archive for','framework_localize') ?> <?php the_time('Y'); ?></p>
	<?php /* If this is an author archive */ } elseif (is_author()) { ?>
	<p class="archive-heading"><?php _e('Author Archive','framework_localize') ?></p>
	<?php /* If this is a paged archive */ } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) { ?>
	<p class="archive-heading"><?php _e('Blog Archives','framework_localize') ?></p>
	<?php } ?>  
