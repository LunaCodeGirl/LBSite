...
a, a:visited {	text-decoration:none; color:<?php echo $highlight_color;?>; -webkit-transition: all 0.3s ease-out; -moz-transition: all 0.3s ease-out; -o-transition: all 0.3s ease-out; -ms-transition: all 1s ease-in-out;}
...
h1, h2, h3, h4, h5, h6 {
	...
	.more,a.more:visited			{	color:<?php echo $highlight_color;?>; <?php echo $main_google_font;?>		font-weight: 700; font-size:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )+2).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>; line-height:1;}
...
p { margin: 0 0 20px 0 !important; font-family: Arial, sans-serif; font-size:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>; line-height:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )+8).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>;}
...
ul.checklist li {	font-family: Arial, sans-serif; font-size:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>; line-height:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )+13).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>;list-style-type: none;background: url('<?php echo $template_uri; ?>/images/icons/check.png') no-repeat left 3px; padding-left: 25px;}

ul.checklist, ul.square {margin-bottom:20px;}

blockquote { border-left: 1px solid #ccc; padding-left: 10px; }
blockquote p{ font-family: Arial, sans-serif; font-size:<?php echo ((get_option_tree( 'aversis_main_font_size', '', false, true, 0 ))+2).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>; line-height:<?php echo (get_option_tree( 'aversis_main_font_size', '', false, true, 0 )+8).get_option_tree( 'aversis_main_font_size', '', false, true, 1 );?>;}
...
***************************/
					...
					#content_container		{	 width:960px; background-color:#fff !important; padding:0px 0px 00px 0px; margin-top: 50px; 
					...
					#content			{	  width:960px;  padding:30px 30px 50px 30px; height:100%; position:relative; display:inline-block; background-color:#fff; margin-left:-30px; border-top:5px solid <?php echo $highlight_color;?>;
											margin-bottom:-6px;
					...
					#footer_content	{	background:#333; width:960px; padding:50px 30px 90px !important; position:relative; display:inline-block !important;  margin-left:-30px;
					   ...
					   @media only screen and (min-width: 0px) and (max-width: 479px) {	
								...
								#content_container		{	margin-top:0px !important; width:300px; padding-left:20px !important; padding-right:20px !important;margin-left:-10px;border-top:5px solid <?php echo $highlight_color;?>}
...
.breadcrumb 		{	float:right; <?php echo $main_google_font;?> text-shadow:1px 1px 0px #fff; font-size:15px; color:#777;}
...
#nav					{	position:relative;	z-index:1000;	height:auto;	font-size:16px;	<?php echo $main_google_font;?>	text-shadow:0px 1px 0px #000;	font-weight:700;color:#e3e3e3; }
...
#nav ul>li				{	line-height:20px; padding:5px 15px; float:left;	 position:relative;	z-index:10; cursor:pointer; border-right:1px solid #666; border-left:1px solid #888;}
...
#nav ul li ul li		{	 margin-top:0px;margin-bottom:0px; padding-bottom:7px; padding-top:5px;padding-left:16px; font-weight:200; border-left:none; border-right:none; background:#333; margin-left:0px !important; margin-right:0px !important;clear:both;  border-bottom:1px solid #222; border-top:1px solid #444;width:160px; }
...
********************************/
	...
	.tp-global				{	min-width:32px; height:23px;  padding-left:41px; padding-top:8px; margin-bottom:10px; background:url(../images/icons/Globe2.png) no-repeat 0px 0px;}	
...
.subfootertext a:hover		{	color:<?php echo $highlight_color;?>;}
...
.sidebar	ul.tabs {
		...
		font-size:<?php echo get_option("aversis_main_font_size");?>;
	}
.sidebar	ul.tabs li {
		display: block;
		width: auto;
...
.sidebar	ul.tabs-content > li.active { display: block; border-bottom:0 !important; font-size:<?php echo get_option("aversis_main_font_size");?> !important;}
...
*************************************/
	...
	.large-button-wrap		{	}
	.large-button							{	filter: dropshadow(color=#333333, offx=0, offy=1);	font-weight:700; <?php echo $main_google_font;?>
													 border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; 													 
