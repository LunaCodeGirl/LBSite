...
function averis_slider_menu() {
	add_submenu_page('option_tree', 'Sliders', 'Sliders', 'manage_options', 'averis-slider-admin', 'averis_slider_admin',get_template_directory_uri()."/icon.png", 100 );
}
					...
					<div id="pageparentdiv" class="saloonbannerwindows postbox" style="width:900px;margin-top:20px;">
						...
						<!-- Basic Container -->
							<div id="general_options">
								...
								<div class="one_third bordered">
									<div class="banner_option">										
											<label for="<?php echo $banner_id;?>banner_font">Google Font in Banner</label><br>
