 ...
 */
      $option_tree_options = add_menu_page('Averis','Averis Options', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ), get_template_directory_uri()."/icon.png",99 );     
      // add menu item
    ...
    else
    {
      ...
      // create menu items
      add_menu_page( 'OptionTree', 'Averis', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ), get_template_directory_uri()."/icon.png",99);
      //$option_tree_options = add_submenu_page( 'option_tree', 'Aversis', 'Theme Options', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ));
//freshline
/*    add_object_page( 'OptionTree', 'Aversis Options', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ), get_template_directory_uri()."/icon.png");
 */     $option_tree_options = add_submenu_page( 'option_tree', 'Averis Options', 'Theme Options', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ));
  ...
  {
    // enqueue styles
    wp_enqueue_style( 'option-tree-style', OT_PLUGIN_URL.'/assets/css/styler.css', false, $this->version, 'screen');
    ...
    wp_enqueue_script( 'jquery-option-tree-custom', OT_PLUGIN_URL.'/assets/js/jquery.custom.options.js', array('jquery'), $this->version );
...
function option_tree_add_slider2() 
  {
    $count = $_GET['count'] + 1;
    $id = $_GET['slide_id'];
    $image = array(
    ...
    option_tree_slider_view2( $id, $image, $this->get_option_page_ID('media'), $count );
    die();
  }
