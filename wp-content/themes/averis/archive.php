...
<?php
	...
	// Page Options
		...
		$averis_headline = $averis_archive;
		if(is_tag()) $averis_headline = $averis_tags;
		...
		if(is_tax()){
        	...
        	$averis_headline = $portfolio_name[$portfolio_counter]." $averis_category ".$htitle_cat;
        }
