	...
	<div class="divide10"></div>						
	    ...
	    <div id="commentfields" <?php echo $comments_style; ?>><div id="respond"></div>
	        <form name="comment_form_name" method="post" action="<?php echo site_url( '/wp-comments-post.php' ); ?>">
				...
				<div class="leftfloat"><input type="submit" id="From_Comment_Go" value="Submit Comment" class="submitbutton bfade"/><?php comment_id_fields(); ?><?php do_action('comment_form', $post->ID); ?></div>
			</form>
	    </div>
	    <div class="clear"></div>
