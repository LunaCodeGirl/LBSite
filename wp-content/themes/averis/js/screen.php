...
jQuery(document).ready(function() {	
	...
	<!-- DEMO COLORPICKER -->
			jQuery('#optionsbtn').click(function(){
				  if(jQuery('#optionswrap').position().left !=0) 
						jQuery('#optionswrap').animate({left: "0px"}, 300 );
					else
						jQuery('#optionswrap').animate({left: "-222px"}, 300 );
			});
			
			jQuery('.le_a').click(function() {	setColor('1D78CB');	});
			jQuery('.le_b').click(function() {	setColor('c91e1e');	});
			jQuery('.le_c').click(function() {	setColor('ff7700');	});
			jQuery('.le_d').click(function() {	setColor('369e19');	});
			jQuery('.le_e').click(function() {	setColor('784e24');	});
			jQuery('.le_f').click(function() {	setColor('b10075');	});
			
			
			jQuery('.pattern1').click(function() { 
				
				jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern1.png)'}); 
			});
			jQuery('.pattern2').click(function() { jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern2.png)'}); });
			jQuery('.pattern3').click(function() { jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern3.png)'}); });
			jQuery('.pattern4').click(function() { jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern4.png)'}); });
			jQuery('.pattern5').click(function() { jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern5.png)'}); });
			jQuery('.pattern6').click(function() { jQuery('.tp-bg-img-intern div').css({'background':'url(http://www.themepunch.com/averis/wp-content/themes/averis/images/bg/pattern6.png)'}); });
			...
			/*jQuery('#colorSelector').ColorPicker({
				...
				onChange: function (hsb, hex, rgb) {
					jQuery('#colorwechsler').data('hex',hex);
					jQuery('#packme').css({'backgroundColor':'#'+hex});
				}
			});*/
			
			jQuery('#colorwechsler').click(function() {
				setColor(jQuery(this).data('hex'));
				jQuery('#packme').css({'backgroundColor':'#'+hex});
				return false;
			});
