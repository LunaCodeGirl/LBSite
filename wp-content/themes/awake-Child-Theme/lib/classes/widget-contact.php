...
class MySite_Contact_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
		...
		<?php if ( $address2 ) : ?>
		<span class="contact_widget_address"><?php echo $address2; ?></span><br /> <?php endif; ?>
		<?php if ( $city ) : ?>
    ...
    function form($instance) {				
		...
		<p><label for="<?php echo $this->get_field_name('address2'); ?>"><?php _e( 'Address:', MYSITE_ADMIN_TEXTDOMAIN ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('address2'); ?>" name="<?php echo $this->get_field_name('address2'); ?>" type="text" value="<?php echo $address; ?>" /></p>
