...
$use_smtp = '0';
$emailto = /*rb_contact_email_address*/"your@email.com"/*e*/;

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'You\'ve got a new email from your website!';
	$message = '';
	$response = '';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = /*rb_contact_response_good*/"Thank you. Your messsage has been received."/*e*/;
	$response_error = /*rb_contact_response_bad*/"Error. Please try again."/*e*/;
