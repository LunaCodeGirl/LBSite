...
function galleryposttype() {
	...
	$labels = array(
		'name' => __( 'Gallery', 'ikaros' ),
		'singular_name' => __( 'Project', 'ikaros' ),
		'add_new' => __( 'Add New', 'ikaros' ),
		'add_new_item' => __( 'Add New Project', 'ikaros' ),
		'edit_item' => __( 'Edit Project', 'ikaros' ),
		'new_item' => __( 'Add New', 'ikaros' ),
		'view_item' => __( 'View Project', 'ikaros' ),
		'search_items' => __( 'Search Gallery', 'ikaros' ),
...
function galleryposttype_add_help_text( $contextual_help, $screen_id, $screen ) { 
    ...
    $contextual_help = 
		...
		'</ul>' .
		'<p>' . __('You can also edit multiple posts at once. Select the posts you want to edit using the checkboxes, select Edit from the Bulk Actions menu and click Apply. You will be able to change the metadata (Gallery Categories, author, etc.) for all selected posts at once. To remove a post from the grouping, just click the x next to its name in the Bulk Edit area that appears.', 'ikaros') . '</p>' .
		'<p><strong>' . __('For more information:', 'ikaros') . '</strong></p>' .
