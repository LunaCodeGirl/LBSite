...
<head>
	<title><?php _e("Insert Shortcode", 'ikaros'); ?></title>
	...
	<div>
		...
		<div class="clean">
			...
			<select id="rbShortcodeType">
				...
				<!--<option data-id="#rbTextBox">Code Box</option>-->
				...
				<!--<option data-id="#rbImage">Image</option>-->
				<option data-id="#rbLateProjects">Latest Projects</option>
				<option data-id="#rbLatePosts">Latest Posts</option>
				...
				<option data-id="#rbSocial">Social Icons</option>
				<option data-id="#rbTabs">Tabs</option>
				<option data-id="#rbTagline">Tagline</option>
				<option data-id="#rbTitleTagline">Title + Tagline</option>
		...
		<div id="rbShortcodePanels" class="clean panels">
			...
			<div data-type="mark" id="rbMark">
				...
				<div class="field">
					<label for="rbMarkStyle">Style:</label>
					<select id="rbMarkStyle">
						<option>lite1</option>
						<option>lite2</option>
					</select>
				</div>	
			...
			<div data-type="titleTagline" id="rbTitleTagline">
				<p>Title + Tagline</p>
				
				<div class="field">
					<label for="rbTitleTaglineTitle">Title:</label>
					<input id="rbTitleTaglineTitle" type="text" value="" />
				</div>
				
				<div class="field">
					<label for="rbTitleTaglineTagline">Tagline:</label>
					<textarea id="rbTitleTaglineTagline" type="text"></textarea>
				</div>
			
			</div>

			<div data-type="lateprojects" id="rbLateProjects">
				<p>Latest Projects</p>

				<div class="field">
					<label for="rbLateProjectsNo">Number of projects(3/row):</label>
					<input id="rbLateProjectsNo" type="text" value="6" />
				</div>
			</div>

			<div data-type="lateposts" id="rbLatePosts">
				<p>Latest Posts</p>

				<div class="field">
					<label for="rbLatePostsNo">Number of posts(2/row):</label>
					<input id="rbLatePostsNo" type="text" value="4" />
				</div>
			</div>
			...
			<div data-type="pricingTable" id="rbPricingTable">
				...
				<div class="boxes">
					...
					<div class="field nochild">
						<label for="rbPricingTableFields">Number of tables:</label>
						<select id="rbPricingTableFields">
							<option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
					...
					<div class="enclosed first">
						...
						<div class="field">
							<label for="rbPricingTableStyle">Style:</label>
							<select class="rbPricingTableStyle">
								<option>1</option>
								<option>2</option>
								<option>3</option>
								<option>4</option>
						...
						<div class="field">
							...
							<input class="rbPricingTablePriceSign" type="text" value="" />
							<span class="description indented"><br />$, &euro; or whatever..</span>
						</div>
						
						<div class="field">
							<label>Price Second Line:</label>
							<input class="rbPricingTablePriceLine" type="text" value="" />
							<span class="description indented"><br />This is a second line of text below the price.</span>
						</div>
						
						<div class="field">
							<label>Content:</label>
							<textarea class="rbPricingTableContent"></textarea>
							<span class="description indented"><br />You should write features in an <strong>unordered list</strong>.</span>
						</div>
			...
			<div data-type="social" id="rbSocial">
				<p>Social Icons</p>
				...
				<div class="boxes">
					...
					<div class="enclosed first">
						...
						<div class="field">
							<label>RSS:</label>
							<input id="rbSocialRSS" type="text" value="" />
						</div>

						<div class="field">
							<label>Facebook:</label>
							<input id="rbSocialFacebook" type="text" value="" />
						</div>

						<div class="field">
							<label>Twitter:</label>
							<input id="rbSocialTwitter" type="text" value="" />
						</div>

						<div class="field">
							<label>Dribbble:</label>
							<input id="rbSocialDribbble" type="text" value="" />
						</div>

						<div class="field">
							<label>Pinterest:</label>
							<input id="rbSocialPinterest" type="text" value="" />
						</div>

						<div class="field">
							<label>LinkedIn:</label>
							<input id="rbSocialLinkedIn" type="text" value="" />
						</div>

						<div class="field">
							<label>Vimeo:</label>
							<input id="rbSocialVimeo" type="text" value="" />
						</div>

						<div class="field">
							<label>LastFM:</label>
							<input id="rbSocialLastFM" type="text" value="" />
						</div>

						<div class="field">
							<label>Tumblr:</label>
							<input id="rbSocialTumblr" type="text" value="" />
						</div>

						<div class="field">
							<label>Forrst:</label>
							<input id="rbSocialForrst" type="text" value="" />
						</div>

						<div class="field">
							<label>Skype:</label>
							<input id="rbSocialSkype" type="text" value="" />
						</div>

						<div class="field">
							<label>Flickr:</label>
							<input id="rbSocialFlickr" type="text" value="" />
						</div>

						<div class="field">
							<label>Deviantart:</label>
							<input id="rbSocialDeviantart" type="text" value="" />
						</div>

						<div class="field">
							<label>Google:</label>
							<input id="rbSocialGoogle" type="text" value="" />
						</div>

						<div class="field">
							<label>FriendFeed:</label>
							<input id="rbSocialFriendFeed" type="text" value="" />
						</div>
			...
			<div data-type="tagline" id="rbTagline">
				<p>Tagline box</p>
				
				<div class="field">
					<label for="rbTaglineContent">Content:</label>
					<textarea id="rbTaglineContent"></textarea>
				</div>
		...
		<div class="clean">
			...
			<div class="mceActionPanel" style="overflow: hidden; margin-top: 20px;">
				<div style="float: left">
					<input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'ikaros'); ?>" onclick="tinyMCEPopup.close();" class="button" />
				</div>
				<div style="float: right">
					<button id="insertCode" value="<?php _e("Insert", 'ikaros'); ?>" class="button" type="button"><?php _e("Insert", 'ikaros'); ?></button>
				</div>
				<div style="float: right">
					&nbsp;
				</div>
				<div style="float: right">
					<button id="previewCode" value="<?php _e("Preview", 'ikaros'); ?>" class="button" type="button"><?php _e("Preview", 'ikaros'); ?></button>
				</div>
			</div>
		</div>
