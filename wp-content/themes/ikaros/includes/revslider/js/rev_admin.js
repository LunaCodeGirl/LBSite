var RevSliderAdmin = new function(){
		...
		var enableSliderViewResponsitiveFields = function(enableRes,enableWidth,isMaxHeight){
			...
			if(enableRes){	
				...
				$('#responsitive_w3').prop('disabled', true);
				$('#responsitive_w2').prop('disabled', true);
				$('#responsitive_w1').prop('disabled', true);
			}else{
		...
		var initSliderViewCustomControls = function(){
			...
			jQuery("#slider_type_1").click(function(){
				enableSliderViewResponsitiveFields(false,true,false);
			});
			
			//responsitive
			jQuery("#slider_type_2").click(function(){
				enableSliderViewResponsitiveFields(true,true,false);
			});
