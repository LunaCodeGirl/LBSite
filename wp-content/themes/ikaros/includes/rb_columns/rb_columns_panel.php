...
<head>
	<title><?php _e("Insert Columns", 'ikaros'); ?></title>
...
<!-- <form onsubmit="insertLink();return false;" action="#"> -->
	...
	<div id="gridExamples" class="container_16">
		...
		<div class="grid_16 holder" data-grid="one_sixth"><div class="grid_1 margin">&nbsp;</div><div class="grid_2">1/6</div></div>
		<div class="grid_16 holder" data-grid="one_fifth"><div class="grid_1 margin">&nbsp;</div><div class="grid_3">1/5</div></div>
		<div class="grid_16 holder" data-grid="one_fourth"><div class="grid_1 margin">&nbsp;</div><div class="grid_4">1/4</div></div>
		<div class="grid_16 holder" data-grid="three_fourth"><div class="grid_1 margin">&nbsp;</div><div class="grid_12">3/4</div></div>
		<div class="grid_16 holder" data-grid="one_third"><div class="grid_1 margin">&nbsp;</div><div class="grid_5">1/3</div></div>
		<div class="grid_16 holder" data-grid="two_third"><div class="grid_1 margin">&nbsp;</div><div class="grid_10">2/3</div></div>
		...
		<div class="grid_16 clean">
			<div class="mceActionPanel" style="overflow: hidden; margin-top: 20px;">
				<div style="float: left">
					<input type="button" id="cancel" name="cancel" value="<?php _e("Cancel", 'ikaros'); ?>" onclick="tinyMCEPopup.close();" />
				</div>
